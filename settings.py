# Django settings for starend project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'starend',                      # Or path to database file if using sqlite3.
        'USER': 'simple',                      # Not used with sqlite3.
        'PASSWORD': '156324',                  # Not used with sqlite3.
...
SECRET_KEY = '!2s7f(!i#f8hf5z2!s6m!-a^mu**d3w%)&nbl5ylvi44-jsb_6'
